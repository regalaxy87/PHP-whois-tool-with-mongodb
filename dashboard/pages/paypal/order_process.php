...
define('CLIENT_ID', 'AbKeCVSICFMbxXk8J1ruoVcHSeoZfNhfZzACtR0uba_AzaJ_ZLwZQTb06mr9uWyk8o3I5i4bi5UJS33q'); //your PayPal client ID
define('CLIENT_SECRET', 'EBrfEcxXmX-aL82tnvlIeakSxJM6yPEoV6fpTf5uy9UpdiKHTMl6nuuQjZzhx_vWhSLuSjI-Gor6ns0T'); //PayPal Secret
define('RETURN_URL', 'http://localhost/class/paypal/order_process.php'); //return URL where PayPal redirects user
define('CANCEL_URL', 'http://localhost/class/paypal/payment_cancel.html'); //cancel URL
define('PP_CURRENCY', 'USD'); //Currency code
define('PP_CONFIG_PATH', 'home/path-to-config-file/'); //PayPal config path (sdk_config.ini)
