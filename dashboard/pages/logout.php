...
<head>
    ...
    <title><?php echo $title;?> Dashbaord Logout</title>
    ...
    <div id="wrapper">
       ...
       <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php"><?php echo $title;?> Dashbaord Logout</a>
            </div>
            <!-- /.navbar-header -->
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Session Expired</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
						...
						<h3> you have been logged out, you will be redirect after 5 seconds </h3>
                            </div>
                            <!-- /.table-responsive -->
