...
<head>
    ...
    <title><?php echo $title;?> Dashbaord My Websites</title>
    ...
    <div id="wrapper">
       ...
       <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php"><?php echo $title;?> Dashbaord My Websites</a>
            </div>
            <!-- /.navbar-header -->
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Websites and Queue</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
<?php
		...
		$db 				= $con_mongo->$tb_addurl;
		$selection 			= $db->$myusers_tb_addurl;
		$document 			= array("email" => $_SESSION["sessemail"]); //"_id" => "_id",
		$result 			= $selection->findOne($document);
...
echo  '<tr>';
    ...
    echo '<td>'.$doc["start_date"].'</td>';
    echo '<td class="center">'.$doc["end_date"].'</td>';
echo  '</tr>';
  }
?>
                                    </tbody>
